...
## Plot France
########################################################################################################################################
pdf('3_BordetellaPertussis/2_analysis_index/2_find_index_groups/Index_pertussis_france_groups.pdf', width = 5/2.54, height = 5/2.54)
...
tiplabels(pch = 16, col = dataset_with_nodes$group_color[which(dataset_with_nodes$is.node == 'no')], cex = 0.2)
